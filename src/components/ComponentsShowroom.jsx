...
function SidePanelDemo() {
  ...
  return (
    <>
      <div style={rowStyle}>
        <ShowcaseItem label="default — Contenido simple">
          <Button variant="secondary" size="md" onClick={() => { setVariant('simple'); }}>
            Abrir panel simple
          </Button>
        </ShowcaseItem>

        <ShowcaseItem label="con-formulario — Formulario de notificación">
          <Button variant="primary" size="md" onClick={() => { setAsunto(''); setCuerpo(''); setVariant('formulario'); }}>
            Abrir panel con formulario
          </Button>
        </ShowcaseItem>

        <ShowcaseItem label="con-scroll — Contenido extenso">
          <Button variant="secondary" size="md" onClick={() => { setVariant('scroll'); }}>
            Abrir panel con scroll
          </Button>
        </ShowcaseItem>
      </div>
      ...
      >
        <p style={{ margin: 0, fontSize: 14, color: '#333333', lineHeight: '20px' }}>
          Este es el SidePanel en su forma más básica. Acepta cualquier contenido como <code>children</code>.
        </p>
        <p style={{ margin: 0, fontSize: 14, color: '#666666', lineHeight: '20px' }}>
          Cierra con el botón <strong>X</strong> en la esquina superior derecha o haciendo clic en el backdrop oscuro.
        </p>
        <div style={{ display: 'flex', gap: 12 }}>
          <Button variant="secondary" size="md" onClick={() => setVariant(null)}>Cancelar</Button>
          <Button variant="primary"   size="md" onClick={() => setVariant(null)}>Aceptar</Button>
        </div>
      </SidePanel>

      {/* ── Variante: con-formulario ── */}
      <SidePanel
        title="Invitación"
        open={variant === 'formulario'}
        onClose={() => setVariant(null)}
      >
        <InputField
          label="Asunto *"
        ...
        <div style={{ display: 'flex', gap: 24, alignItems: 'flex-start' }}>
          <InputField label="Fecha programada *" value="" onChange={() => {}} hideIcon supportingText=" " />
          <InputField label="Hora programada *"  value="" onChange={() => {}} hideIcon supportingText=" " />
        </div>
        <Textarea
          label="Cuerpo del mensaje"
          value={cuerpo}
          onChange={v => setCuerpo(v)}
        ...
        <InputField
          ...
          hideIcon
        />
        <div style={{ backgroundColor: '#EBF5FF', borderRadius: 8, padding: '12px 16px', borderLeft: `4px solid ${c.auxiliar.$value}` }}>
          <p style={{ margin: 0, fontSize: 12, color: '#666666', lineHeight: '18px' }}>
        ...
        <div style={{ display: 'flex', gap: 16, paddingTop: 8 }}>
          <Button variant="secondary" size="md" onClick={() => setVariant(null)}>Cancelar</Button>
          <Button variant="primary"   size="md" onClick={() => setVariant(null)}>Guardar notificación</Button>
        </div>
      </SidePanel>
      ...
      >
        {Array.from({ length: 6 }, (_, i) => (
          <div key={i} style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            <p style={{ margin: 0, fontSize: 14, fontWeight: 500, color: c['primario-oscuro'].$value }}>
              Sección {i + 1}
            </p>
            <p style={{ margin: 0, fontSize: 14, color: '#666666', lineHeight: '20px' }}>
              {LOREM}
        ...
        <div style={{ display: 'flex', gap: 16, paddingTop: 8 }}>
          <Button variant="secondary" size="md" onClick={() => setVariant(null)}>Cancelar</Button>
          <Button variant="primary"   size="md" onClick={() => setVariant(null)}>Guardar</Button>
        </div>
      </SidePanel>
    </>
  );
    ...
    <div style={pageStyle}>
      ...
      <main style={mainStyle}>
        ...
        <section id="card-option" style={sectionStyle}>
          <div style={sectionHeadStyle}>
            ...
            <p style={sectionDescStyle}>
              ...
              Variantes: básica · con badge "Recomendada" · seleccionada · con botón link (WBadge-ActivedButton) · interactiva.
              Fuente: Figma 2q8xKT2K5Qu065dZvUuUNZ · nodo 1160:5263.
            </p>
          </div>

          <GroupLabel>Estados (Figma: Default → WBadge → WBadge-Actived → WBadge-ActivedButton)</GroupLabel>
          <div style={{ ...rowStyle, flexWrap: 'wrap', alignItems: 'flex-start' }}>
            ...
            <ShowcaseItem label='WBadge-ActivedButton — badge + botón link'>
              <div style={{ width: 300 }}>
                <CardOption
                  title="180°"
                  subtitle="La más usada"
                  description="El jefe evalúa al colaborador y el colaborador se auto-evalúa."
                  recommended
                  buttonLabel="Agregar evaluadores"
                  onButtonClick={() => {}}
                />
              </div>
            </ShowcaseItem>
        ...
        {/* ══════════════════════════════════════════════
            22. SIDE PANEL
        ══════════════════════════════════════════════ */}
        <section id="side-panel" style={sectionStyle}>
          <div style={sectionHeadStyle}>
            <h2 style={sectionTitleStyle}>SidePanel</h2>
            <p style={sectionDescStyle}>
              Panel deslizable desde la derecha (580 px) con backdrop, animación slideIn y área de contenido scrollable.
              Header fijo con título en panel (#5780AD, 22 px) y botón X (importante #00B4FF).
              Cierra al pulsar X o el backdrop.
            </p>
          </div>
